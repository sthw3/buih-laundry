...
<div class="wrapper">
    ...
    <nav class="sidebar">
        ...
        <a href="manageService.php" class="nav-link-item active">
    ...
    <main class="main-content">
        ...
        <div class="table-container">
            ...
            <a href="createService.php" class="btn" style="background:#253154; color:white;">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="editService.php?id=<?= $row['Service_ID'] ?>" class="btn-action edit-btn"><i class="bi bi-pencil-fill"></i></a>
                                 <a href="deleteService.php?id=<?= $row['Service_ID'] ?>" class="btn-action delete-btn"
