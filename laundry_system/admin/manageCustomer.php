...
<div class="wrapper">
    ...
    <nav class="sidebar">
        ...
        <a href="manageCustomer.php" class="nav-link-item active">
   ...
   <main class="main-content">
        ...
        <div class="table-container">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="createCustomer.php" class="btn btn-customer">
                ...
                <table class="table table-hover align-middle">
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?= htmlspecialchars($row['Cust_PhoneNum']) ?>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="editCust.php?id=<?= $row['Customer_ID'] ?>"
                                       class="btn-action edit-btn"><i class="bi bi-pencil-fill"></i></a>

                                    <a href="deleteCust.php?id=<?= $row['Customer_ID'] ?>"
