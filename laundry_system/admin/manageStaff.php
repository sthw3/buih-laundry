...
<div class="wrapper">
  ...
  <!-- ── SIDEBAR ─────────────────────────────────────────── -->
    <nav class="sidebar">
        ...
        <a href="manageStaff.php" class="nav-link-item active">
    ...
    <main class="main-content">
        ...
        <div class="table-container">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="createStaff.php" class="btn" style="background:#253154; color:white;">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="editStaff.php?id=<?= $row['Staff_ID'] ?>" class="btn-action edit-btn"><i class="bi bi-pencil-fill"></i></a>
                                <a href="deleteStaff.php?id=<?= $row['Staff_ID'] ?>" class="btn-action delete-btn"
                                onclick="return confirm('Are you sure you want to delete this staff, this action cannot be undone.');">
